...
# 16~48회 대비 압도적으로 안정적).
PRE_BUILDUP_TEXT = {
    "pre_buildup_a.wav": "음...",  # 0.48s, 1회 시도로 무음 0곳 통과
    "pre_buildup_b.wav": "어...",  # 0.64s, 1회 시도로 무음 0곳 통과
    "pre_buildup_c.wav": "오호",  # 0.72s, 1회 시도로 무음 0곳 통과
    "pre_buildup_d.wav": "흠",  # 0.56s, 2회 시도로 무음 0곳 통과
